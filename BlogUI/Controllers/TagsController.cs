...
namespace BlogUI.Controllers
{
    public class TagsController : Controller
    {
        ...
        {
            var blogContext = _context.Tags.Include(t => t.Creator).Include(t => t.Post);
        ...
        public async Task<IActionResult> Create([Bind("Id,Tag,PostId,CreatorId")] TagModel tagModel)
        {
            ...
            ViewData["PostId"] = new SelectList(_context.Posts, "Id", "PostBody", tagModel.PostId);
            return View(tagModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tag,PostId,CreatorId")] TagModel tagModel)
        {
            if (id != tagModel.Id)
            {
                return NotFound();
